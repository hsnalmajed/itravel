...
export const dictionaries = {
  ar: {
    ...
    visa: {
      ...
      statusArrival: "تأشيرة عند الوصول",
      statusEta: "تأشيرة أو تصريح إلكتروني",
      statusRequired: "تأشيرة مسبقة",
      statusFilterLabel: "ماذا تحتاج للدخول؟",
      statusSource: "المصدر الرسمي",
      statusChecked: "تحقّقنا منه في {date}",
      statusUntil: "بحسب المصدر، هذا الترتيب سارٍ حتى {date}.",
      statusHeading: "دخول {country} بالجواز السعودي",
      directoryConfirmedOnly: "نعرض فقط الدول التي تحقّقنا من حالتها من مصدرها الرسمي، ولها رابط تقديم متحقَّق منه. دول أخرى نعمل على التحقق منها وستُضاف.",
      badgeOfficial: "بوابة رسمية",
      badgeDirect: "دايركت",
      routeFilterLabel: "أين تقدّم؟",
      routeAll: "الكل",
      routeOfficial: "بوابة الدولة الرسمية",
      routeDirect: "عبر دايركت",
      routeBoth: "الاثنان",
      directoryOnlyVerified: "نعرض فقط الدول التي عندنا لها رابط تقديم متحقَّق منه: بوابة الدولة الرسمية للتأشيرة، أو صفحة دايركت الخاصة بها.",
    ...
    citySeasons: {
      modeQuestion: "ما سؤالك؟",
      byMonth: "حسب الشهر",
      byMonthHint: "اختر شهراً، ونعرض لك المدن التي يكون فيها في موسمها",
      byCity: "حسب المدينة",
      byCityHint: "اختر مدينة، ونعرض لك طقسها وفصلها في كل شهر من السنة",
      changeMode: "تغيير طريقة العرض",
      monthNames: ["يناير", "فبراير", "مارس", "أبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"],
      inSeasonInMonth: "مدن في موسمها في {month} ({count})",
      noneInMonth: "لا توجد مدن في موسمها في هذا الشهر ضمن هذه القارة.",
      citySearch: "اكتب اسم المدينة أو الدولة…",
      cityNoMatch: "لا توجد مدينة بهذا الاسم.",
      pickCity: "ابحث عن مدينة أعلاه لترى طقسها شهراً بشهر.",
      cityYearTitle: "{city} على مدار السنة",
      bestMonths: "أشهر الموسم: {months}",
      noBestMonths: "لا يوجد شهر يحقق شرط الموسم في هذه المدينة — راجع الأرقام أدناه واختر ما يناسبك.",
      unreliable: "مصدر بيانات الطقس لهذه المدينة أبرد من الواقع صيفاً (نقطة القياس تقع فوق البحر)، لذلك نعرض الأرقام كما هي ولا نحدد لها موسماً.",
      inSeasonLabel: "موسم",
      high: "🌡 {high}° نهاراً",
      rainNone: "🌧 لا مطر تقريباً",
      rainOne: "🌧 يوم ممطر واحد من ٣٠",
      rainTwo: "🌧 يومان ممطران من ٣٠",
      rainFew: "🌧 {count} أيام ممطرة من ٣٠",
      rainMany: "🌧 {count} يوماً ممطراً من ٣٠",
      kinds: { winter: "شتاء", spring: "ربيع", summer: "صيف", autumn: "خريف", wet: "موسم الأمطار", dry: "موسم الجفاف" },
      rule: "كيف نحدد الموسم: يكون الشهر «موسماً» للمدينة إذا كان متوسط حرارة النهار فيه بين ١٨ و٣٢ درجة، وأيام المطر ٨ أو أقل. الفصل يُحسب من موقع المدينة: الشتاء في النصف الشمالي هو الصيف في الجنوبي، والمدن الاستوائية ليس فيها شتاء وصيف بل «موسم أمطار» (١٠ أيام ممطرة أو أكثر) و«موسم جفاف».",
      source: "الأرقام متوسطات ٢٠ سنة (٢٠٠٥–٢٠٢٤) لموقع كل مدينة من بيانات NASA POWER.",
      viewCity: "معالم المدينة",
    },
    seasons: {
      title: "مواسم السفر",
      subtitle: "متى تكون كل مدينة في موسمها، وكيف طقسها وفصلها في كل شهر — من بيانات طقس ٢٠ سنة",
      intro:
    ...
    productSelect: {
      label: "ماذا تبحث عنه؟",
      flightsTitle: "طيران",
      flightsHint: "رحلات حقيقية بتواريخك",
      hotelsTitle: "فنادق",
      hotelsHint: "إقامة في وجهتك",
      chooseFirst: "اختر طيران أو فنادق للبدء",
    },
    hotelForm: {
      knownTitle: "لدي فندق محدد",
      knownHint: "أعرف اسم الفندق",
      discoverTitle: "اقترح لي فندق",
      discoverHint: "فنادق ضمن ميزانيتي",
      hotelName: "الفندق",
      hotelNamePlaceholder: "اكتب اسم الفندق",
      errorHotelName: "اكتب اسم الفندق",
      city: "الوجهة",
      cityPlaceholder: "اكتب اسم المدينة",
      errorCity: "اكتب اسم المدينة",
      dates: "تواريخ الإقامة",
      errorCheckIn: "اختر تاريخ الوصول",
      errorCheckOut: "اختر تاريخ المغادرة",
      budget: "ميزانية الفندق",
      budgetPlaceholder: "للإقامة كاملة",
      submitKnown: "ابحث عن الفندق",
      submitDiscover: "اقترح لي فنادق",
    },
    hotelResults: {
      eyebrowKnown: "فندقك",
      eyebrowDiscover: "فنادق في وجهتك",
      backToSearch: "تعديل البحث",
      nights: "{count} ليالٍ",
      oneNight: "ليلة واحدة",
      guests: "{count} نزلاء",
      yourSearch: "بحثك",
      stars: "{count} نجوم فأكثر",
      anyStars: "أي تصنيف",
      breakfast: "الإفطار مشمول",
      budgetTotal: "ميزانيتك: {amount}",
      budgetPerNight: "≈ {amount} لليلة",
      honestTitle: "الأسعار عند الشريك، لا عندنا — حتى الآن",
      honestBody:
        "لا نعرض أسعار الفنادق داخل سفرتنا بعد: لا نملك مصدراً حقيقياً لها، ولن نكتب سعراً لا نعرفه. اضغط على شريك أدناه فيفتح بحثك نفسه — نفس الفندق أو المدينة، نفس التواريخ وعدد النزلاء — وتقارن هناك.",
      honestFilters: "يُطبَّق عند Booking.com: التصنيف، والإفطار، ونوع الإقامة. أمّا الميزانية فقارنها بنفسك مع السعر المعروض هناك.",
      openAt: "ابحث في {partner}",
      partnerNote: "يفتح موقع الشريك في نافذة جديدة. السعر والتوفّر وشروط الإلغاء يحددها الشريك.",
      missing: "البحث ناقص — ارجع وأكمل الخانات.",
      apartment: "شقة",
      room: "غرفة فندقية",
    },
    home: {
      ...
      seasonSubtitle: "مدن يكون طقسها هذا الشهر معتدلاً وقليل المطر: الحرارة نهاراً بين ١٨ و٣٢ درجة في المتوسط، والمطر ٨ أيام أو أقل من أيام الشهر — بحسب طقس آخر عشرين سنة.",
      ...
      seasonFlight: "ابحث عن طيران",
      seasonFlightTitle: "ابحث عن رحلات طيران إلى أقرب مطار: {airport} (يبعد {km} كم عن المدينة)",
      seasonHigh: "🌡 {high}° نهاراً",
      seasonRainNone: "🌧 لا مطر تقريباً",
      seasonRainOne: "🌧 يوم ممطر واحد من ٣٠",
      seasonRainTwo: "🌧 يومان ممطران من ٣٠",
      seasonRainFew: "🌧 {count} أيام ممطرة من ٣٠",
      seasonRainMany: "🌧 {count} يوماً ممطراً من ٣٠",
    ...
    results: {
      ...
      budgetBarBudget: "ميزانية الطيران: {amount}",
      budgetBarParty: "الأسعار أدناه للمسافرين كلهم ({count}) — لا للشخص الواحد",
      budgetBarCheapest: "أرخص رحلة: {amount}",
      budgetBarLeft: "يتبقى من ميزانيتك: {amount}",
      budgetBarWithin: "{within} من {total} رحلة معروضة ضمن ميزانيتك",
      budgetBarOver: "{count} تتجاوز ميزانيتك — ما زالت معروضة أدناه",
      budgetBarAllOver: "كل الرحلات المعروضة تتجاوز ميزانيتك. أرخص سعر لوجهتك يبدأ من {amount} — أي {over} فوق ميزانيتك.",
      budgetBarWaiting: "نقارن الأسعار بميزانيتك حين ينتهي البحث…",
      cardBoth: "★ الأرخص والأفضل معاً",
      cardOutbound: "الذهاب",
      cardReturn: "العودة",
      cardLeg: "الرحلة",
      cardDirect: "مباشرة",
      cardOneStop: "توقف واحد",
      cardStops: "{count} توقفات",
      cardBagExtra: "الأمتعة غير مشمولة",
      cardBagIn: "الأمتعة مشمولة",
      cardFits: "ضمن ميزانيتك · يتبقى {amount}",
      cardOver: "فوق ميزانيتك بـ {amount}",
      budgetBarOtherCurrency: "الأسعار أدناه بعملة غير عملة ميزانيتك، فلا نقارنها بها — غيّر العملة من أعلى الويدجت لتظهر المقارنة.",
      ...
      hotelNextTitle: "حجزت طيرانك؟ الخطوة التالية: فندق في {city}",
      hotelNextBody: "من {checkIn} إلى {checkOut}، {nights}، ولنفس عدد المسافرين — جاهز في صفحة الفنادق.",
      hotelNextCta: "ابحث عن فندق",
  ...
  en: {
    ...
    visa: {
      ...
      statusEta: "e-Visa or e-authorisation",
      statusRequired: "Visa in advance",
      statusFilterLabel: "What do you need to enter?",
      statusSource: "Official source",
      statusChecked: "Checked on {date}",
      statusUntil: "According to the source, this arrangement runs until {date}.",
      statusHeading: "Entering {country} on a Saudi passport",
      directoryConfirmedOnly: "Only countries whose status we confirmed from an official source, and that have a verified application link, are listed. Others are being checked and will be added.",
      badgeOfficial: "Official portal",
      badgeDirect: "Direct",
      routeFilterLabel: "Where to apply",
      routeAll: "All",
      routeOfficial: "Country's official portal",
      routeDirect: "Through Direct",
      routeBoth: "Both",
      directoryOnlyVerified: "Only countries we hold a verified application link for are listed: the country's own visa portal, or its page on Direct.",
    ...
    citySeasons: {
      modeQuestion: "What's your question?",
      byMonth: "By month",
      byMonthHint: "Pick a month and see the cities in season then",
      byCity: "By city",
      byCityHint: "Pick a city and see its weather and season in every month",
      changeMode: "Change view",
      monthNames: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
      inSeasonInMonth: "Cities in season in {month} ({count})",
      noneInMonth: "No city on this continent is in season this month.",
      citySearch: "Type a city or country…",
      cityNoMatch: "No city by that name.",
      pickCity: "Search for a city above to see its weather month by month.",
      cityYearTitle: "{city} through the year",
      bestMonths: "In season: {months}",
      noBestMonths: "No month meets the season rule in this city — see the numbers below and choose what suits you.",
      unreliable: "Our weather source reads this city cooler than it really is in summer (its measuring cell sits over the sea), so we show the numbers as they are and give it no season.",
      inSeasonLabel: "In season",
      high: "🌡 {high}° by day",
      rainNone: "🌧 almost no rain",
      rainOne: "🌧 1 rainy day of 30",
      rainTwo: "🌧 2 rainy days of 30",
      rainFew: "🌧 {count} rainy days of 30",
      rainMany: "🌧 {count} rainy days of 30",
      kinds: { winter: "Winter", spring: "Spring", summer: "Summer", autumn: "Autumn", wet: "Rainy season", dry: "Dry season" },
      rule: "How we decide: a month is in season for a city when its average daytime high is 18–32 °C and it rains on 8 days or fewer. The season comes from where the city is: northern winter is southern summer, and tropical cities have no winter or summer but a rainy season (10 or more rainy days) and a dry season.",
      source: "Figures are 20-year averages (2005–2024) for each city's location, from NASA POWER.",
      viewCity: "City guide",
    },
    seasons: {
      title: "Travel Seasons",
      subtitle: "When each city is in season, and its weather and season every month — from 20 years of weather data",
      intro:
    ...
    productSelect: {
      ...
      flightsHint: "Real flights on your dates",
      hotelsTitle: "Hotels",
      hotelsHint: "A place to stay",
      chooseFirst: "Choose flights or hotels to start",
    },
    hotelForm: {
      knownTitle: "I have a hotel in mind",
      knownHint: "I know the hotel's name",
      discoverTitle: "Suggest a hotel",
      discoverHint: "Hotels within my budget",
      hotelName: "Hotel",
      hotelNamePlaceholder: "Type the hotel's name",
      errorHotelName: "Type the hotel's name",
      city: "Destination",
      cityPlaceholder: "Type a city",
      errorCity: "Type a city",
      dates: "Stay dates",
      errorCheckIn: "Choose a check-in date",
      errorCheckOut: "Choose a check-out date",
      budget: "Hotel budget",
      budgetPlaceholder: "For the whole stay",
      submitKnown: "Find this hotel",
      submitDiscover: "Suggest hotels",
    },
    hotelResults: {
      eyebrowKnown: "Your hotel",
      eyebrowDiscover: "Hotels at your destination",
      ...
      budgetTotal: "Your budget: {amount}",
      budgetPerNight: "≈ {amount} a night",
      honestTitle: "Prices are at the partner, not here — for now",
      honestBody:
        "We don't show hotel prices on Sfrtna yet: we have no real source for them, and we won't print a price we don't know. Pick a partner below and it opens your exact search — the same hotel or city, the same dates and guests — to compare there.",
      honestFilters: "Applied at Booking.com: star rating, breakfast and stay type. Compare your budget against the price shown there.",
      openAt: "Search on {partner}",
      partnerNote: "Opens the partner's site in a new tab. Price, availability and cancellation terms are set by the partner.",
      missing: "The search is incomplete — go back and fill in the fields.",
      apartment: "Apartment",
      room: "Hotel room",
    },
    home: {
      ...
      seasonSubtitle: "Cities whose weather this month is mild and mostly dry: daytime highs of 18–32 °C on average and rain on 8 days or fewer — based on the last twenty years.",
      ...
      seasonFlight: "Search flights",
      seasonFlightTitle: "Search flights to the nearest airport: {airport} ({km} km from the city)",
      seasonHigh: "🌡 {high}° by day",
      seasonRainNone: "🌧 almost no rain",
      seasonRainOne: "🌧 1 rainy day of 30",
      seasonRainTwo: "🌧 2 rainy days of 30",
      seasonRainFew: "🌧 {count} rainy days of 30",
      seasonRainMany: "🌧 {count} rainy days of 30",
    ...
    results: {
      ...
      budgetBarBudget: "Flight budget: {amount}",
      budgetBarParty: "Prices below are for all travellers ({count}), not per person",
      budgetBarCheapest: "Cheapest flight: {amount}",
      budgetBarLeft: "Left of your budget: {amount}",
      budgetBarWithin: "{within} of {total} flights shown fit your budget",
      budgetBarOver: "{count} go over your budget — still shown below",
      budgetBarAllOver: "Every flight shown is over your budget. The cheapest to your destination starts at {amount} — {over} over.",
      budgetBarWaiting: "Comparing fares with your budget once the search finishes…",
      cardBoth: "★ Cheapest and best",
      cardOutbound: "Outbound",
      cardReturn: "Return",
      cardLeg: "Flight",
      cardDirect: "direct",
      cardOneStop: "1 stop",
      cardStops: "{count} stops",
      cardBagExtra: "Baggage not included",
      cardBagIn: "Baggage included",
      cardFits: "Within budget · {amount} left",
      cardOver: "{amount} over budget",
      budgetBarOtherCurrency: "The prices below are in a different currency from your budget, so we don't compare them — switch the widget's currency to see the comparison.",
      ...
      hotelNextTitle: "Booked your flight? Next: a hotel in {city}",
      hotelNextBody: "From {checkIn} to {checkOut}, {nights}, same party — ready on the hotels page.",
      hotelNextCta: "Find a hotel",
