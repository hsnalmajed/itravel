...
export const dictionaries = {
  ...
  en: {
    ...
    hero: {
      ...
      subtitle:
        "We compare flights and hotels across trusted sources and build you a full day-by-day plan — with attraction maps, visa requirements and daily-updated currency rates in one place.",
