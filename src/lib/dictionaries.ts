...
export const dictionaries = {
  ar: {
    ...
    visa: {
      ...
      checkedAt: "آخر تحقق من المصدر: {date}",
      ...
      applySubtitle: "كل الدول في قائمة واحدة — ابحث أو صفّي حسب نوع الدخول، واضغط الدولة لتفاصيلها وطريقة التقديم",
      canApply: "التقديم متاح ←",
    ...
    legal: {
      ...
      aboutSourcesBody:
        "أسعار الطيران والفنادق من مزوّدي بيانات السفر، ومتطلبات التأشيرة من جدول ويكيبيديا المحدَّث مع روابط للمصادر الرسمية، والمعالم وأوصافها من ويكيبيديا وويكيداتا، والخرائط من OpenStreetMap، وأسعار الصرف محدَّثة يومياً. كل صفحة تذكر مصدرها.",
      ...
      privacyThirdBody:
        "عند الانتقال إلى موقع شريك للحجز، تنطبق سياسة خصوصية ذلك الموقع على ما تفعله هناك. الخرائط من OpenStreetMap والصور من ويكيميديا، ولكل منهما سياسته.",
      ...
      termsContentBody:
        "أوصاف الأماكن وصورها من ويكيبيديا وويكيميديا بموجب رخصها، وكل صورة تذكر مصوّرها ورخصتها. بيانات الخرائط من OpenStreetMap ومساهميها. اسم سفرتنا وشعاره ملك لأصحابه.",
  ...
  en: {
    ...
    visa: {
      ...
      applySubtitle: "Every country in one list — search or filter by entry type, and tap a country for its details and how to apply",
      canApply: "Apply here →",
    ...
    legal: {
      ...
      aboutSourcesBody:
        "Flight and hotel prices come from travel data providers; visa requirements from Wikipedia's maintained table, with links to the official sources; attractions and their descriptions from Wikipedia and Wikidata; maps from OpenStreetMap; and exchange rates updated daily. Every page names its source.",
      ...
      privacyThirdBody:
        "When you continue to a partner's site to book, that site's privacy policy governs what you do there. Maps come from OpenStreetMap and photographs from Wikimedia, each with its own policy.",
